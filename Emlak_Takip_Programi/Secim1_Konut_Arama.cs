...
{
    public partial class Secim1_Konut_Arama : Form
    {
        public Secim1_Konut_Arama()
        {
            InitializeComponent();
        }
        ...
        private void Secim1_Konut_Arama_Load(object sender, EventArgs e)
        {
        ...
        private void cbAmac_SelectedIndexChanged(object sender, EventArgs e)
        {
        }

        private void dgKayitlar_CellContentClick(object sender, DataGridViewCellEventArgs e)
        {
